...
import { EncounterComponent } from 'app/entities/encounter/encounter.component';
...
describe('Component Tests', () => {
  describe('Encounter Management Component', () => {
    let comp: EncounterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EncounterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.encounters && comp.encounters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
