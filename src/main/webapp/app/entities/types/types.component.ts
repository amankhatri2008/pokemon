...
export class TypesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.typesService
        ...
        .subscribe(
          (res: HttpResponse<ITypes[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  trackId(index: number, item: ITypes): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('typesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITypes[] | null, headers: HttpHeaders, page: number): void {
