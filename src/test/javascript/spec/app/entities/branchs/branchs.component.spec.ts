...
import { BranchsComponent } from 'app/entities/branchs/branchs.component';
import { BranchsService } from 'app/entities/branchs/branchs.service';
import { Branchs } from 'app/shared/model/branchs.model';

describe('Component Tests', () => {
  describe('Branchs Management Component', () => {
    let comp: BranchsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BranchsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.branchs && comp.branchs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
